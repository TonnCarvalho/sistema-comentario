...
<div x-cloak x-show="canEdit">
    ...
    <textarea x-ref="comment" id="comment" name="comment" rows="6"
    ...
    <button x-on:click="updateComment({{ $comment->id }})"
        class="bg-green-400 p-2 rounded text-xs cursor-pointer">Update</button>
    <button x-on:click="canEdit=false; errorValidateEdit=''" class="bg-amber-400 p-2 rounded text-xs cursor-pointer">Back to back</button>
